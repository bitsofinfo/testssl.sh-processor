            ...
            for config_filename, config in result_handler_configs.items():
                ...
                try:
                    ...
                    evaluation_doc = {
                                ...
                                'testssl_results_path':os.path.dirname(testssl_json_result_file_path).replace(input_dir+"/","")
                              }
                    ...
                    if 'path_properties_grok' in config and config['path_properties_grok'] is not None:
                        ...
                        del matches['ignored']
                        path_properties = {
                                          config['evaluation_doc_config']['target_keys']['path_properties']:matches
                                          }
                        evaluation_doc.update(path_properties)
